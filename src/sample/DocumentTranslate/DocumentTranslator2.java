...
public class DocumentTranslator2 {
    private static final String GOOGLE_TRANSLATE_URL = "http://translate.google.com/translate_a/single";

    /**
     * Private to prevent instantiation
     */
    public DocumentTranslator2() {
    };

    public static String generateURL(String sourceLanguage , String targetLanguage , String text) throws UnsupportedEncodingException {
    ...
    public String translateIt(String langFrom, String langTo, String text) {
        try {
            return this.translate(langFrom, langTo, text);
        } catch (Exception ex) {
            return "Cannot access to the internet!";
        }
    }

    private String translate(String sourceLanguage , String targetLanguage , String text) throws IOException {
